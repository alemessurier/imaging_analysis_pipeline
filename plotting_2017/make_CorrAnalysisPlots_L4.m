function  make_CorrAnalysisPlots_L4( paths_NH,paths_EN,npSub )
...
for K=1:length(paths_EN)
    ...
    [ results ] = find_corrInBarrel(sigROIs,traceByStim,framesEvoked,ROIsInBarrel,sponTrace,ROI_positions,mag );
...
%% subfunction definitions  
    ...
    function [numBins,meanDist,meanNC,semNC,meanSC,semSC,shuff_meanNC,...
        ...
        shuffSC=shuffSC(sortInds);
        [numBins,binEdges,binInds]=histcounts(ROIdist,10);
