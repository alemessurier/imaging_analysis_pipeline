function [results_EN,results_NH]=make_responseDistPlots_BarrVSept( pathNames,npSub,r)
% 
...
% find barrel and septal cells for each field

for K=1:length(pathNames)
    [ barrelROIs{K},septalROIs{K} ] = find_septalVbarrel(pathNames{K},npSub,r)
end
%%

[ blank_rawDF_EN,BW_rawDF_EN,nonBW_rawDF_EN,CW_rawDF_EN,BW_Z_EN,nonBW_Z_EN,...
    CW_Z_EN,numBW_EN,numSigW_EN,fano_by_whisk_EN,medianRs_EN,fano_CW_EN,SW_Z_EN,SW_rawDF_EN]=find_response_dists(pathNames,npSub,r,barrelROIs);
[ blank_rawDF_NH,BW_rawDF_NH,nonBW_rawDF_NH,CW_rawDF_NH,BW_Z_NH,nonBW_Z_NH,...
    CW_Z_NH,numBW_NH,numSigW_NH,fano_by_whisk_NH,medianRs_NH,fano_CW_NH,SW_Z_NH,SW_rawDF_NH]=find_response_dists(pathNames,npSub,r,septalROIs);
