function  make_CorrAnalysisPlots_NPsubCompare( paths_NH,paths_EN )
...
%                     dists,ROIsInBarrel,ROItoBarrel,ROI_positions,~,~,~,~,mag ] = load_NPsub_data_L23( paths_EN{K},r );
%          
...
%        
%                 [traceByStim,sponTrace,framesEvoked,permTestResults,...
%                     dists,ROIsInBarrel,ROItoBarrel,ROI_positions,~,~,~,~,mag ] = load_NPsub_data_L23( paths_NH{K},r );
%         [ results ] = find_corrInBarrel(permTestResults,traceByStim,framesEvoked,ROIsInBarrel,sponTrace,ROI_positions,mag );
%         if ~isempty(results(1).NC)
...
% %     title(['NC for shared BW pairs vs. all pairs, r=',num2str(r)])
...
% %     legend('BWshared NH','BWshared EN','NH all','ENall')
% %     title(['SC for shared BW pairs vs. all pairs, r=',num2str(r)])
% %     xlabel('signal corr')
% %     ylabel('')
% %     
...
%     
%     [numBins_NH,dist_NH,meanNC_NH,semNC_NH,meanSC_NH,semSC_NH]=...
%         binCorrByDist(NC_NH_all,shuffNC_NH_all,SC_NH_all,shuffSC_NH_all,ROIdist_NH_all);
%     
%     
%     
%     %%
...
%     
%     [numBins_EN,dist_EN,meanNC_EN,semNC_EN,meanSC_EN,semSC_EN]=...
%         binCorrByDist(NC_EN_all,shuffNC_EN_all,SC_EN_all,shuffSC_EN_all,ROIdist_EN_all);
%     
%     % make CDF plots
...
%     
%     [numBins_NH_CW,dist_NH_CW,meanNC_NH_CW,semNC_NH_CW,meanSC_NH_CW,...
%         semSC_NH_CW]=binCorrByDist(NC_NH_CW,shuffNC_NH_CW,SC_NH_CW,shuffSC_NH_CW,ROIdist_NH_CW);
%     
%     [~,~,meanNC_NH_CW_only,semNC_NH_CW_only]=binCorrByDist(NC_NH_CW_only,shuffNC_NH_CW_only,SC_NH_CW,shuffSC_NH_CW,ROIdist_NH_CW);
%     
%     [~,~,~,~,meanSC_NH_SW,semSC_NH_SW]=binCorrByDist(NC_NH_CW,shuffNC_NH_CW,SC_NH_SW,shuffSC_NH_SW,ROIdist_NH_CW);
%     %%
...
%         semSC_EN_CW]=binCorrByDist(NC_EN_CW,shuffNC_EN_CW,SC_EN_CW,shuffSC_EN_CW,ROIdist_EN_CW);
%     
%     [~,~,meanNC_EN_CW_only,semNC_EN_CW_only]=binCorrByDist(NC_EN_CW_only,shuffNC_EN_CW_only,SC_EN_CW,shuffSC_EN_CW,ROIdist_EN_CW);
%     
%     [~,~,~,~,meanSC_EN_SW,semSC_EN_SW]=binCorrByDist(NC_EN_CW,shuffNC_EN_CW,SC_EN_SW,shuffSC_EN_SW,ROIdist_EN_CW);
%     
%     
% %     % make CDF plots
...
%     
%     ylabel('mean NC')
%     title(['within column pairs, r=',num2str(r)])
% %     hold on
...
% %     ylabel('mean SC')
% %     title(['in column pairs, surround RF, r=',num2str(r)])
%     
    ...
    [numBins_EN_inBarr,meanDist_EN_inBarr,meanNC_EN_inBarr,semNC_EN_inBarr,...
        meanSC_EN_inBarr,semSC_EN_inBarr]=binCorrByDist(NC_EN_inBarr,NC_EN_inBarr,SC_EN_inBarr,SC_EN_inBarr,ROIdist_EN_inBarr);
    
    [numBins_EN_xBarr,meanDist_EN_xBarr,meanNC_EN_xBarr,semNC_EN_xBarr,...
        meanSC_EN_xBarr,semSC_EN_xBarr]=binCorrByDist(NC_EN_xBarr,NC_EN_xBarr,SC_EN_xBarr,SC_EN_xBarr,ROIdist_EN_xBarr);
    
    [numBins_NH_inBarr,meanDist_NH_inBarr,meanNC_NH_inBarr,semNC_NH_inBarr,...
        meanSC_NH_inBarr,semSC_NH_inBarr]=binCorrByDist(NC_NH_inBarr,NC_NH_inBarr,SC_NH_inBarr,SC_NH_inBarr,ROIdist_NH_inBarr);
    
    [numBins_NH_xBarr,meanDist_NH_xBarr,meanNC_NH_xBarr,semNC_NH_xBarr,...
        meanSC_NH_xBarr,semSC_NH_xBarr]=binCorrByDist(NC_NH_xBarr,NC_NH_xBarr,SC_NH_xBarr,SC_NH_xBarr,ROIdist_NH_xBarr);
    ...
    ylabel('mean NC')
    legend('NH','EN')
    title(['across column pairs, r=',num2str(r)])
...
%% subfunction definitions
    ...
    function ax=make_distVCorr_plot(dist_NH,numBins_NH,dist_EN,numBins_EN,...
        ...
        indsUse_EN=numBins_EN>1;
        indsUse_NH=numBins_NH>1;
