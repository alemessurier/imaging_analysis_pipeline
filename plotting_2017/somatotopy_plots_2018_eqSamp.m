function [pvals,CWtuned_byRad,CWtuned_byRad_num,CWresp_byDist]=somatotopy_plots_2018_eqSamp( paths_NH,paths_EN,npSub,rval,ROIs_EN,ROIs_NH )
...
[mean_dist_NH,mean_percMatch_NH,sem_percMatch_NH,percMatch_byBarr_NH,percMatch_NH,num_ROIs_NH,CWtunedInds_binned_NH,binEdges]=plot_CWtunedByRad(paths_NH,npSub,rval,15,ROIs_NH);
...
[mean_dist_num_NH,mean_percMatch_num_NH,sem_percMatch_num_NH,percMatch_byBarr_num_NH,percMatch_num_NH,num_ROIs_num_NH,CWtunedInds_binned_NH,binEdges]=plot_CWtunedByRad_num(paths_NH,npSub,rval,15,ROIs_NH);
...
%%
[mean_dist_NH,mean_responseZ_NH,sem_responseZ_NH,mean_responseDF_NH,sem_responseDF_NH,num_ROIs_NH,CW_Z_NH,CW_dF_NH,responsesZ_NH,responsesDF_NH,binEdges]=plot_CWresponseByRad(paths_NH,npSub,rval,15,ROIs_NH);
...
compareRFsharpness(paths_EN,paths_NH,npSub,'',ROIs_EN,ROIs_NH,'BW');
pvals.EBW=p_EBW;
pvals.RFsize=p_sig;
% for K=1:length(paths_EN)
%     switch npSub
